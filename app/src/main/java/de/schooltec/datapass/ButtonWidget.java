        ...
        protected void onPostExecute(final Boolean success)
        {
            ...
            if (success)
            {
                ...
                remoteViews.setImageViewBitmap(R.id.imageView,
                        WidgetDialogActivity.circularImageBar((int) (alreadyUsed * 100f)));
            }
            else
            {
                ...
                String amount = sharedPref.getString(context.getString(R.string.saved_actualAmount),
                        context.getString(R.string.nodata_usage_actual)) + "/\n" + sharedPref
                        .getString(context.getString(R.string.saved_maxAmount),
                                context.getString(R.string.nodata_usage_max));
                ...
                remoteViews.setImageViewBitmap(R.id.imageView,
                        WidgetDialogActivity.circularImageBar((int) (fraction * 100f)));
            }
            // request for widget update
            pushWidgetUpdate(context, remoteViews);
        }
